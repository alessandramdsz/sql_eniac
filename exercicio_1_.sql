...
--Crie um único relatório para encontrar o "Aluno Destaque". Este aluno é aquele com a maior média de notas finais. A consulta deve mostrar o nome do aluno e a sua média de notas, arredondada para duas casas decimais. 
